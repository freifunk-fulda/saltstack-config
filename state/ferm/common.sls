...
ferm.default:
  file.managed:
    ...
    - source: salt://ferm/files/ferm.default
    - user: root
    - group: root
    - mode: 644
    - makedirs: True
...
ferm.ipv4.conf:
  file.managed:
    ...
    - source: salt://ferm/files/ferm.ipv4.conf
    - user: root
    - group: root
    - mode: 644
    - makedirs: True
...
ferm.ipv6.conf:
  file.managed:
    ...
    - source: salt://ferm/files/ferm.ipv6.conf
    - user: root
    - group: root
    - mode: 644
    - makedirs: True
...
ferm.drop:
  file.managed:
    ...
    - source: salt://ferm/files/98-drop.conf
    - user: root
    - group: root
    - mode: 644
    - makedirs: True
...
ferm.hooks:
  file.managed:
    ...
    - source: salt://ferm/files/99-hooks.conf
    - user: root
    - group: root
    - mode: 644
    - makedirs: True
...
ferm.restart.fail2ban:
  file.managed:
    ...
    - source: salt://ferm/files/restart_fail2ban.sh
    - user: root
    - group: root
    - mode: 755
    - makedirs: True
